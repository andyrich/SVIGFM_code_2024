...
def set_zoneentire_start_values(df):
    ...
    parvals = dict(
        ...
        zoneentire_hk_cityson=['log', 1., 0.001, 1000],
        zoneentire_hk_eastside=['log', 1., 0.001, 1000],
        zoneentire_hk_highlands=['log', 1., 0.001, 1000],
        zoneentire_hk_kenwood=['log', 1, 0.001, 1000],
        zoneentire_hk_southcent=['log', 1.0, 0.001, 1000],
        zoneentire_hk_vom=['log', 1, 0.001, 1000],
        zoneentire_hk_westside=['log', 1., 0.001, 1000],  # not equal to 1
        zoneentire_ss_aguacal=['log', 1, 0.001, 1000],
        zoneentire_ss_bay=['log', 1, 0.001, 1000],
        zoneentire_ss_cityson=['log', 1, 0.001, 1000],
        zoneentire_ss_eastside=['log', 1., 0.001, 1000],  # not equal to 1
...
def set_laymult_start_values(df):
    ...
    parvals = dict(
        ...
        laymult_hk2=['log', 0.1, 1e-5, 100, ],
        laymult_hk3=['log', 0.1, 1e-5, 100, ],
        laymult_hk4=['log', 0.5, 1e-5, 100, ],
        laymult_hk5=['log', 0.1, 1e-5, 100, ],
        laymult_hk6=['log', 0.1, 1e-5, 100, ],
        ...
        laymult_vk1=['log', 5, 1, 1000],
        laymult_vk2=['log', 10, 1, 1000],
        laymult_vk3=['log', 10, 1, 1000],
        laymult_vk4=['log', 10, 1, 1000],
        laymult_vk5=['log', 10, 1, 1000],
        laymult_vk6=['log', 10, 1, 1000],
